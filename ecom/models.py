...
class ProductSustainabilityData(models.Model):
    product = models.OneToOneField('Product', on_delete=models.CASCADE)
    materials_footprint = models.DecimalField(max_digits=10, decimal_places=2)
    production_footprint = models.DecimalField(max_digits=10, decimal_places=2)
    packaging_footprint = models.DecimalField(max_digits=10, decimal_places=2)
    transportation_footprint = models.DecimalField(max_digits=10, decimal_places=2)
    disposal_footprint = models.DecimalField(max_digits=10, decimal_places=2)
    ...
    def total_carbon_footprint(self):
        return sum([
            self.materials_footprint,
            self.production_footprint,
            self.packaging_footprint,
            self.transportation_footprint,
            self.disposal_footprint
        ])
...
class UserCarbonFootprint(models.Model):
    ...
    @property
    def net_carbon_footprint(self):
        return self.total_carbon_footprint - self.offset_amount
...
class CarbonOffsetProject(models.Model):
    ...
    description = models.TextField()
    cost_per_ton = models.DecimalField(max_digits=10, decimal_places=2)
